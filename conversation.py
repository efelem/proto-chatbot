...
class Conversation:
    ...
    def from_gradio_chatbot(self, gradio_history):
        for human,ai in gradio_history:
            self.messages.append([self.roles[0], human] )
            self.messages.append([self.roles[1], ai] )
...
def get_default_conv_template(model_name):
    ...
    if "vicuna" in model_name or "output" in model_name:
        print("Loading conv_vicuna_v1_1 conversations module")
        return conv_vicuna_v1_1
    elif "alpaca" in model_name:
        print("Loading conv_dolly conversations module")
        return conv_dolly
    elif "oasst" in model_name and "pythia" in model_name:
        print("Loading oasst conversations module")
        return conv_oasst
